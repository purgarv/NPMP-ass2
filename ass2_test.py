...
Y = odeint(counter_3bit_asynchronous, Y0, T, args=(params_ff,))
# Y = odeint(counter_3bit_synchronous, Y0, T, args=(params_ff,))
# Y = odeint(counter_3bit_synchronous_ce, Y0, T, args=(params_ff,))
